...
import com.atguigu.newgulimall.gulimallmember.service.UmsGrowthChangeHistoryService;
...
public class UmsGrowthChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimallmember:umsgrowthchangehistory:list")
    ...
    //@RequiresPermissions("gulimallmember:umsgrowthchangehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimallmember:umsgrowthchangehistory:save")
    ...
    //@RequiresPermissions("gulimallmember:umsgrowthchangehistory:update")
    ...
    //@RequiresPermissions("gulimallmember:umsgrowthchangehistory:delete")
