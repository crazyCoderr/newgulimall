...
public class UmsMemberCollectSpuController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimallmember:umsmembercollectspu:list")
    ...
    //@RequiresPermissions("gulimallmember:umsmembercollectspu:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimallmember:umsmembercollectspu:save")
    ...
    //@RequiresPermissions("gulimallmember:umsmembercollectspu:update")
    ...
    //@RequiresPermissions("gulimallmember:umsmembercollectspu:delete")
